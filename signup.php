		...
		<div class="MID" id="test">
			...
			<div class="form" style="margin-left: 500px;">
				<form action="personal.php">
					...
					<p class="form">Re-Enter Password</p>
					<input type="text" /><br/>
					
					<button class="button button2" >SIGN UP</button>
					<div style="float:right;width:900px;align:center">
						Returning Customer?<a href="signin.php" onclick="signin();" style="text-decoration:none;"><p onMouseOver="this.style.color='#000000'"   onMouseOut="this.style.color='#6D6C6C'" style="color:#6D6C6C;">SIGN IN</p></a>
					</div>
